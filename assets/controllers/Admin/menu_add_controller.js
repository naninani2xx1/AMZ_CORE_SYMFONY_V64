...
export default class extends Controller {
    ...
    async connect() {
        ...
        this.component = await getComponent(document.getElementById('TableMenuLive'));
    }
        ...
        axiosPost({url, data: formData},{
            ...
            failed: res => {
                if(res.status === 422){
                    ...
                    const divElement = doc.querySelector('[data-Admin--menu-add-target="render"]');
                    this.renderTarget.innerHTML = divElement.innerHTML;
                }
            },
            final: _ => {}
        });
